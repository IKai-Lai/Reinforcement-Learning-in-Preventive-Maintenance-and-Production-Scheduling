...
### HR Learning (Heuristic R Learning) algorithm
  ...
  <img src="https://github.com/IKai-Lai/Reinforcement-Learning-in-Preventive-Maintenance-and-Production-Scheduling/blob/main/image/property2.png" width="580" height="60">
  To proove it, for any statr i, if
  <img src="https://github.com/IKai-Lai/Reinforcement-Learning-in-Preventive-Maintenance-and-Production-Scheduling/blob/main/image/property2_pf1.png" width="580" height="60">
  then a<sub>N+1</sub> must be the best action to choose. <br>
  And h(i) here represent the infinite horizon discounted expected rewrd function. According to the other paper refered here, it is a non-increasing function.  So
  <img src="https://github.com/IKai-Lai/Reinforcement-Learning-in-Preventive-Maintenance-and-Production-Scheduling/blob/main/image/property2_pf2.png" width="580" height="60">
  Thus, when c<sub>m</sub>(i, a<sub>N+1</sub>) ≤ min<sub>a≠a<sub>N+1</sub></sub>[c<sub>p</sub>(i, a)t<sub>n</sub> − r<sub>o</sub>(i, a)] holds, there must be R(i, a<sub>N+1</sub>) >= R(i, a) holds, so that the first inequation hold, the proof complete.
